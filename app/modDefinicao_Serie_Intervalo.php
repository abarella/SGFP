...
function definirSerieAtividadeTable(event) {
...
function validarCampos() {
    ...
    if (inicio === "") {
        ...
        document.getElementById('cmbAtvIni').focus();
        return false;
    }
    ...
    if (fim === "") {
        ...
        document.getElementById('cmbAtvFim').focus();
        return false;
    }
                ...
                <form name='formDefinicaoSerie' action="<?php echo $_SG['rf'] .'functions.php'; ?>" method="POST"
                    ...
                    <div class="row">
                        <div class="col-md-3 mt-4">
                            <label for="cmbAtvIni" class="d-block">Atividade Inicial:</label>
                            <select id="cmbAtvIni" class="form-control mt-2">
                                <?php
                                    for ($i = 1; $i <= 200; $i++) {
                        ...
                        <div class="col-md-3 mt-4">
                            <label for="cmbAtvFim" class="d-block">Atividade Final:</label>
                            <select id="cmbAtvFim" class="form-control mt-2">
                                <?php
                                    for ($i = 1; $i <= 200; $i++) {
                                        echo "<option value='$i'>$i</option>";
                                    }
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <br>
                            <input type="submit" class="btn btn-primary" id="definirSerieAtividade"
                                name="definirSerieAtividade" onclick="definirSerieAtividadeTable(event)" value="Gravar"
                                required />
                        </div>
                    </div>
                </form>
